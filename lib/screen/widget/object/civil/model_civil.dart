...
class ModelCivil extends StatelessWidget {
  final String documentId;

  ModelCivil({required this.documentId});

  Future addUserDetails(
    String object,
    int id,
  ) async {
    await FirebaseFirestore.instance.collection('civil').add({
      'object': object,
      'id': id.toString(),
    });
  }
  ...
  Widget build(BuildContext context) {
    ...
    CollectionReference users = FirebaseFirestore.instance.collection('civil');
