...
class ModelEletric extends StatelessWidget {
  final String documentId;

  ModelEletric({required this.documentId});

  Future addUserDetails(
    String object,
    int id,
  ) async {
    await FirebaseFirestore.instance.collection('ele').add({
      'object': object,
      'id': id.toString(),
    });
  }
  ...
  Widget build(BuildContext context) {
    ...
    CollectionReference users = FirebaseFirestore.instance.collection('ele');
